...
const LoginForm = ({ userState }) => {
    ...
    return (
        <div className="card">
            ...
            <button onClick={googleSignIn}> <img src="https://us.123rf.com/450wm/kornienko/kornienko1611/kornienko161100200/66047248-chisinau-moldova-november-16-2016-google-logo-on-pc-screen-google-it-is-the-largest-internet-search-.jpg?ver=6" alt="" /> <span>Sign in With Google</span></button>
